MAKEFILE:
 Για compile όλων τον test καλείται το make ενώ για καθαρισμό από αρχεία db και .o make clean. Με make test1 make test2 κλπ. τρέχει το κάθε τεστ ξεχωριστά.
...
- BPLUS_INDEX_NODE: στο struct αυτο αποθηκευονται μεταδεδομενα σχετικά με ενα block ευρετηρίου. Αυτα περιλαμβλάνουν τα εξης: τον αριθμο κλειδιων που
 εχει το block, το id του block και το id του γονεα.
  ...
  γεμίζοντας το σκουπίδια. Για οποιοδηποτε πληθος εγγραφων μεχρι και τον αριθμο 2324 λειτουργει σωστά το προγραμμα και η GetEntry επιστρέφει 
